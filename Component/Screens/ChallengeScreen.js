...
//     // TODO: Call your challenge API here
//     // const challengeData = {
...
//     Alert.alert(
//       'Challenge Sent! 🎮',
//       `Challenge sent to ${selectedUser.username}. Waiting for response...`,
//       [
//         {
//           text: 'OK',
//           onPress: () => {
//             // Navigate to waiting screen or lobby
...
export default function ChallengeFriends() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      console.log('🔹 Fetching friends with token:', token.substring(0, 10) + '...');
      ...
      console.log('✅ Friend API Response:', JSON.stringify(response.data, null, 2));

      if (response.data.success) {
        setUsers(response.data.friends || []);
      } else {
        console.warn('⚠️ API returned false success:', response.data);
