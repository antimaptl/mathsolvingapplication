    ...
    try {
      ...
      if (data.success) {
        ...
        Toast.show({
          type: 'success',
          text1:
            friendshipStatus === 'pending' ? 'Request Cancelled' : 'Unfriended',
        });
      } else {
  ...
  const Content = () => {
    ...
    return (
      <View style={{flex: 1, paddingTop: insets.top + 30}}>
        ...
        <CustomHeader title="USER PROFILE" onBack={() => Navigation.goBack()} />
                        ...
                        styles.actionButton,
                        {
                          backgroundColor:
                            friendshipStatus === 'accepted'
                              ? '#EF4444' // Red for Remove
                              : friendshipStatus === 'pending'
                              ? '#64748B' // Grey for Cancel
                              : '#3B82F6', // Blue for Add
                        },
                      ]}
                      onPress={
