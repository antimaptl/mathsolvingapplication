...
//         }
//       } else {
//         setLoginError('ID / Password is Incorrect');
//       }
//     } catch (error) {
...
//       <LinearGradient
//         colors={['#0f162b', '#0f162b']}
//         style={styles.formContainer}>
//         {/* HEADER */}
//         <View style={styles.headerContainer}>
//           <TouchableOpacity  onPress={() => navigation.navigate("AuthLandingScreen")}>
//             <Icon
...
//           <TouchableOpacity
//             style={styles.socialButton}
//             onPress={() => Alert.alert('Info', 'Twitter login coming soon')}>
