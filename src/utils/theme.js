...
import { wp, hp, normalizeFont } from "./Responsive";

const { width, height } = Dimensions.get("window");

export const COLORS = {
    // Default palette inferred from user requests
    primary: "#FB923C", // Orange from Login/SignUp
    secondary: "#17677F", // Teal from Social buttons
    background: "#0f162b", // Dark Blue background
...
export const SIZES = {
    ...
    radius: normalizeFont(12),
    radius_sm: normalizeFont(8),
    radius_md: normalizeFont(18),
    padding: normalizeFont(15),
    margin: normalizeFont(15),

    // Font Sizes
    fontLg: normalizeFont(16),
    fontSm: normalizeFont(13),
    fontXs: normalizeFont(12),
...
export const FONTS = {
    fontLg: { fontSize: SIZES.fontLg, color: COLORS.text, lineHeight: normalizeFont(20), fontFamily: 'OpenSans-Regular' },
    font: { fontSize: SIZES.font, color: COLORS.text, lineHeight: normalizeFont(20), fontFamily: 'OpenSans-Regular' },
    fontSm: { fontSize: SIZES.fontSm, color: COLORS.text, lineHeight: normalizeFont(18), fontFamily: 'OpenSans-Regular' },
    fontXs: { fontSize: SIZES.fontXs, color: COLORS.text, lineHeight: normalizeFont(14), fontFamily: 'OpenSans-Regular' },
...
export const IMAGES = {
    // Mapped from existing assets where possible
    bg1: require('../assets/backGroundImage.png'),
    logo: require('../assets/logo.png'),
    logo3: require('../assets/logo3.png'),
    google: require('../assets/google.png'),
    facebook: require('../assets/facebook.png'),
    user: require('../assets/profile.png'), // Default profile
    face: require('../assets/face.png'),
    gender: require('../assets/gender.png'),

    // Placeholders/Commented out missing assets
    ...
    // logoNew: require('../assets/images/logo_new.png'),
    // iconNew: require('../assets/images/icon_new.png'),
    // splashBgNew: require('../assets/images/splash_bg_new.png'),
};
